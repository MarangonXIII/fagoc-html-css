...
function cubo(event) {
    if (event.key === "Enter") {
        ...
        resultado.innerHTML = `
            O produto do dobro do primeiro com metade do segundo: ${total1.toFixed(2)}<br>
            A soma do triplo do primeiro com o terceiro: ${total2.toFixed(2)}<br>
            O terceiro elevado ao cubo: ${total3.toFixed(2)}
        `;
    }
}